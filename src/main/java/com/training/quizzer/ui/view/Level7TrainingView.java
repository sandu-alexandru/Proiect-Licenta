...
@SpringView(name = Level7TrainingView.VIEW_NAME)
public class Level7TrainingView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level7TrainingView";
    ...
    private void addSubmitButtonListener() {
        ...
        returnButton.addClickListener(clickEvent -> getUI().getNavigator().navigateTo(Level7View.VIEW_NAME));
    }
