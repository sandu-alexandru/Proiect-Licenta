...
@SpringView(name = Level7View.VIEW_NAME)
public class Level7View extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level7View";
    public static final String CURRET_LEVEL = "7";
    ...
    private void configureComponents() {
        ...
        addComponent(new Label(" Level 7 evaluation "));
        addComponent(new Label());
        addComponent(new Label());
    ...
    private void addButtonListeners() {
        ...
        testButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level7TestView.VIEW_NAME);
        });
        trainingButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level7TrainingView.VIEW_NAME);
        });
    }
