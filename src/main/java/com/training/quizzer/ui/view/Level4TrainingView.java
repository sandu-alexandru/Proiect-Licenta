...
@SpringView(name = Level4TrainingView.VIEW_NAME)
public class Level4TrainingView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level4TrainingView";
