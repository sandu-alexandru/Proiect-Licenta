...
@SpringView(name = Level3TestView.VIEW_NAME)
public class Level3TestView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level3TestView";
    public static final String CURRENT_LEVEL = "3";
    public static final String NEXT_LEVEL= "4";
...
//        returnButton.addClickListener(clickEvent -> getUI().getNavigator().navigateTo(Level3View.VIEW_NAME));
    }
    ...
    private double getDesiredScore() {
        return (answersMap1.keySet().size() + answersMap2.keySet().size() + answersMap3.keySet().size()) * 0.6;
    }
