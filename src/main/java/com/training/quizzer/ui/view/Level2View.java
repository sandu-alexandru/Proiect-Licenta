...
@SpringView(name = Level2View.VIEW_NAME)
public class Level2View extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level2View";
    ...
    private void configureComponents() {
        ...
        addComponent(new Label(" Level 2 evaluation "));
        addComponent(new Label());
        addComponent(new Label());
    ...
    private void addButtonListeners() {
        ...
        testButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level2TestView.VIEW_NAME);
        });
        trainingButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level2TrainingView.VIEW_NAME);
        });
    }
