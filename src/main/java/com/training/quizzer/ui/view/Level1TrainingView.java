...
@SpringView(name = Level1TrainingView.VIEW_NAME)
public class Level1TrainingView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level1TrainingView";
    ...
    private void addSubmitButtonListener() {
        ...
        returnButton.addClickListener(clickEvent -> getUI().getNavigator().navigateTo(Level1View.VIEW_NAME));
    }
