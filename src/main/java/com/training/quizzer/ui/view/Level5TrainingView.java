...
@SpringView(name = Level5TrainingView.VIEW_NAME)
public class Level5TrainingView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level5TrainingView";
    ...
    private void addSubmitButtonListener() {
        ...
        returnButton.addClickListener(clickEvent -> getUI().getNavigator().navigateTo(Level5View.VIEW_NAME));
    }
