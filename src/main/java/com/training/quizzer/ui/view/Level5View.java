...
@SpringView(name = Level5View.VIEW_NAME)
public class Level5View extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level5View";
    public static final String CURRET_LEVEL = "5";
    ...
    private void configureComponents() {
        ...
        addComponent(new Label(" Level 5 evaluation "));
        addComponent(new Label());
        addComponent(new Label());
    ...
    private void addButtonListeners() {
        ...
        testButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level5TestView.VIEW_NAME);
        });
        trainingButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level5TrainingView.VIEW_NAME);
        });
    }
