...
@SpringView(name = Level5TestView.VIEW_NAME)
public class Level5TestView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level5TestView";
    public static final String CURRENT_LEVEL = "5";
    public static final String NEXT_LEVEL= "6";
    ...
    private double getDesiredScore() {
        return (answersMap1.keySet().size() + answersMap2.keySet().size() + answersMap3.keySet().size()
                + answersMap4.keySet().size() + answersMap5.keySet().size()) * 0.6;
    }
