...
@SpringView(name = Level4View.VIEW_NAME)
public class Level4View extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level4View";
    public static final String CURRET_LEVEL = "4";
    @Autowired
    ...
    private void configureComponents() {
        ...
        addComponent(new Label(" Level 4 evaluation "));
        addComponent(new Label());
        addComponent(new Label());
    ...
    private void addButtonListeners() {
        ...
        testButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level4TestView.VIEW_NAME);
        });
        trainingButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level4TrainingView.VIEW_NAME);
        });
    }
