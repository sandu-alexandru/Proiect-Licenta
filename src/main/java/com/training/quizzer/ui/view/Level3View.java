...
@SpringView(name = Level3View.VIEW_NAME)
public class Level3View extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level3View";
    public static final String CURRET_LEVEL = "3";
    ...
    private void configureComponents() {
        ...
        addComponent(new Label(" Level 3 evaluation "));
        addComponent(new Label());
        addComponent(new Label());
    ...
    private void addButtonListeners() {
        ...
        testButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level3TestView.VIEW_NAME);
        });
        trainingButton.addClickListener(clickEvent -> {
            getUI().getNavigator().navigateTo(Level3TrainingView.VIEW_NAME);
        });
    }
