...
@SpringView(name = Level6TrainingView.VIEW_NAME)
public class Level6TrainingView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level6TrainingView";
    ...
    private void addSubmitButtonListener() {
        ...
        returnButton.addClickListener(clickEvent -> getUI().getNavigator().navigateTo(Level6View.VIEW_NAME));
    }
