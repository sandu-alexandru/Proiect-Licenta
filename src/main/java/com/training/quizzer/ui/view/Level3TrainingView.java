...
@SpringView(name = Level3TrainingView.VIEW_NAME)
public class Level3TrainingView extends VerticalLayout implements View{
    public static final String VIEW_NAME = "level3TrainingView";
