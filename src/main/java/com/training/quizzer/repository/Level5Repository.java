...
@Repository
public interface Level5Repository extends JpaRepository<Level5, Long> {
    ...
    @Query(value = "select d from Level5 d where d.question = :question")
    Level5 getQuestionByQuestion(@Param("question") String question);
