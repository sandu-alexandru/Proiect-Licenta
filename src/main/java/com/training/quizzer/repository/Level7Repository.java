...
@Repository
public interface Level7Repository extends JpaRepository<Level7, Long> {
    ...
    @Query(value = "select d from Level7 d where d.question = :question")
    Level7 getQuestionByQuestion(@Param("question") String question);
