...
@Repository
public interface Level6Repository extends JpaRepository<Level6, Long> {
    ...
    @Query(value = "select d from Level6 d where d.question = :question")
    Level6 getQuestionByQuestion(@Param("question") String question);
