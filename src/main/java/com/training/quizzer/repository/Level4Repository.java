...
@Repository
public interface Level4Repository extends JpaRepository<Level4, Long> {
    ...
    @Query(value = "select d from Level4 d where d.question = :question")
    Level4 getQuestionByQuestion(@Param("question") String question);
